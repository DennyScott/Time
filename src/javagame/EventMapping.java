...
public class EventMapping {
	...
	public ArrayList<Block> onTouchEntities;
	 ...
	 */
	public EventMapping(String ref) throws SlickException {
		
		onTouchEntities = new ArrayList<Block>(); //Collect Blocks that need collision detection
